  ...
  return (
    <form  className="row y-gap-20" onSubmit={handleSubmit} >
      <div className="col-12">
        ...
        {success !== "" ? <Alert color="success"  className="custom-alert" innerRef={alertRef} tabIndex="-1" role="alert"><div>{success}</div></Alert> : null}
        {errors !== "" ? <Alert color="danger" innerRef={alertRef} tabIndex="-1" role="alert" ><div>{errors}</div></Alert> : null}
      </div>
      {/* End .col */}
