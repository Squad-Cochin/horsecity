  ...
  const dropdownOptions = [
    ...
    },
    {
      ...
      list: [
        ...
        { label: "2 Horses", value : 1 },
        { label: "3 Horses", value : 1 },
        { label: "4 Horses", value : 1 },
        { label: "5 Horses", value : 1 },
        { label: "6 Horses", value : 1 },
        { label: "7 Horses", value : 1 },
        { label: "8 Horses", value : 1 },
        { label: "9 Horses", value : 1 },
        { label: "10 Horses", value : 1 },
        { label: "11 Horses", value : 1 },
        { label: "12 Horses", value : 1 },
        { label: "13 Horses", value : 1 },
        { label: "14 Horses", value : 1 },
        { label: "15 Horses", value : 1 },
      ],
