...
const { nameValidation } = require("./checkRequestBodyInput");
...
//                     {
//                         let upQuery = `UPDATE drivers d SET d.deleted_at = NULL WHERE d.id = ${result22[0].id}`;
//                         console.log(`Update Query: `, upQuery);
//                         con.query(upQuery, async (err, result23) =>
//                         {
//                             if(result23.affectedRows > 0)
//                             {
//                                 console.log(`Data was already present but it is updated now`);
...
//                     else
//                     {
//                         let selQuery = `SELECT * FROM drivers d WHERE d.email = ${req.body.email} AND d.deleted IS not NULL`;
//                         console.log(selQuery);
