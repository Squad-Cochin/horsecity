    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        let insQuery = `INSERT INTO ${
          constants.tableName.discount_types
        } (type, name, rate, created_at)
        VALUES ('${type}', '${name}', '${rate}','${time.getFormattedUTCTime(
  ...
  static async getallactivediscount() {
    return await new Promise((resolve, reject) => {
      try {
        ...
        console.log(
          `Error from 'dicount.js' file. In the controllers>dicounts>dicounts.js. Function from which the eror we are getting is 'getallactivediscount' `
        );
      }
    });
  }
