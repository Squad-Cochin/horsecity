...
module.exports = function(app)
{
    ...
    app.post(`/${process.env.apiToken}/add/quotation`,reqValidator.verifyQuotationFields,reqValidator.verifyPickupDate,reqValidator.verifyDropDate,validator.checkValuesEnteredInTheQuotationBody,quotation.addNewQuotation); 
    ...
    app.put(`/${process.env.apiToken}/update/quotation/:id`,reqValidator.verifyQuotationFields,reqValidator.verifyPickupDate,reqValidator.verifyDropDate,quotation.updateQuotation);   
    ...
    app.post(`/${process.env.apiToken}/update-status/quotations`,reqValidator.verifyQuotationFields,reqValidator.verifyPickupDate,reqValidator.verifyDropDate,quotation.updateStatusQuotation);   
