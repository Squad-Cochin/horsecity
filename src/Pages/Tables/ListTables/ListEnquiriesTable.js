...
const ListEnquiriesTable = () => {
    ...
    const tog_confirm = async (id) => {
        ...
        const day = parseInt(pickupDateParts[0]);
                        ...
                        <div className="mb-3">
                            ...
                            <Flatpickr
                                ...
                                options={{
                                    dateFormat: "d-m-Y",
                                    required: true, 
                                    minDate:(pickupDate < new Date() ? new Date() : pickupDate)
                                }}
                                value={validation.values.drop_date || ''}
                                onChange={(dates) =>{pickupDate !==''? validation.setFieldValue('drop_date', dates[0]) : validation.setFieldValue('drop_date', '')}}
