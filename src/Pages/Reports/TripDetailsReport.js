...
const TripDetailsReport = (props) => {
  ...
  return (
    <React.Fragment>
        ...
        <Container fluid>
          <Breadcrumbs title={props.t("Tables")} breadcrumbItem={props.t("Trip Details Reports")} />
...
export default withRouter(withTranslation()(TripDetailsReport));
