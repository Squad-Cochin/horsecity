...
import { getSeviceProviderData } from '../../helpers/ApiRoutes/getApiRoutes';
...
const ServiceProviderReport  = () => {
    ...
    async function getData(page, val){
        setSearchDate(val)
        console.log("val",val)
        // let getAllData = await getSeviceProviderData(page || 1, val)
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Tables" breadcrumbItem="Service Provider Reports" />
                                            ...
                                            <table className="table align-middle table-nowrap" id="customerTable">
                                                <thead className="table-light">
                                                    ...
                                                    <th className="index" data-sort="index">#</th>
                                                        ...
                                                        <th className="sort" data-sort="number">Contact Address</th>
