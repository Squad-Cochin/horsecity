                                            ...
                                            <table className="table align-middle table-nowrap" id="Table">
                                                <thead className="table-light">
                                                    <tr>
                                                        ...
                                                        <th className="sort" data-sort="name">Customer Name</th>
                                                        <th className="sort" data-sort="abbreviation">Customer Email</th>
                                                        <th className="sort" data-sort="created_at">Vehicle Number</th>
                                                        <th className="sort" data-sort="created_at">Rating</th>
                                                        <th className="sort" data-sort="created_at">Reviews</th>
