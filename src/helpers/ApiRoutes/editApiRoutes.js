...
export async function updateSPStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_SP_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateCustomerStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_CUSTOMER_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateVechileStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_VEHICLES_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateVechileImageStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_VEHICLES_IMAGE_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateTaxationStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_TAXATION_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateDriverStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_DRIVERS_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateDiscountStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_DISCOUNTS_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateLanguageStatus(id){
  try{
    const { data } = await axios.put(`${url.PUT_LANGUAGES_UPDATE_STATUS}/${id}`,null,{
      headers: {
          "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`,
        },
  });
...
export async function updateReviewStatus(id){
  try{
    const  data  = await axios.put(`${url.PUT_REVIEW_UPDATE_STATUS}/${id}`,null,{
      headers: {
       "Authorization": `Bearer ${process.env.REACT_APP_ADMIN_API_TOKEN}`, 
      }
  });
